...
class1_weight = 0.95
class2_weight = 0.05
cross_entropy =  tf.reduce_mean(-class1_weight*tf.reduce_sum(y_[:,0] * tf.log(y_conv[:,0]))-class2_weight*tf.reduce_sum(y_[:,1] * tf.log(y_conv[:,1])))
