...
import input_data
DATA_DIR = '/home/wsq/PycharmProjects/liuliang'
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('data_dir', DATA_DIR, 'Directory for storing data')

minst = input_data.read_data_sets(FLAGS.data_dir, one_hot=True)
...
saver.save(sess, '/home/wsq/PycharmProjects/liuliang/model.ckpt')  #保存模型参数，注意把这里改为自己的路径
