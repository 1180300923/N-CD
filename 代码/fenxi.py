...
def imageprepare():
    ...
    """
    file_name='/home/wsq/PycharmProjects/liuliang/image/youtube.pcap.UDP_131-202-240-150_9674_131-202-244-3_53.png'#导入自己的图片地址
...
with tf.Session() as sess:
    sess.run(init_op)
    saver.restore(sess, "/home/wsq/PycharmProjects/liuliang/model.ckpt")#这里使用了之前保存的模型参数
